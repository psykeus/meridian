...
export const DATA_SOURCES: DataSourceConfig[] = [
  // ── AVIATION ────────────────────────────────────────────────────────────
  {
    ...
    icon: "✈",
    category: "Aviation",
    description: "Free global ADS-B aircraft tracker. 50,000+ live aircraft with full transponder data including call sign, altitude, speed, heading, squawk codes, and ICAO24 hex address. Uses OAuth2 Client Credentials flow (Basic Auth is being deprecated).",
