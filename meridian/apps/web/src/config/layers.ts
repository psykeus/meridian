...
export const ALL_LAYERS: LayerConfig[] = [
  ...
  { id: "tornado_warnings",    label: "Tornado & Storm Warnings",   group: "environment",  sourceIds: ["noaa_weather_alerts"],  defaultVisible: false, color: "#ffeb3b", description: "NWS tornado and severe storm alerts" },
  ...
  { id: "tsunami_zones",       label: "Tsunami Warning Zones",      group: "environment",  sourceIds: ["noaa_weather_alerts"],  defaultVisible: false, color: "#00bcd4", description: "Active tsunami watches and warnings" },
  ...
  { id: "dust_storms",         label: "Dust Storm Coverage",        group: "environment",  sourceIds: ["noaa_weather_alerts"],  defaultVisible: false, color: "#bcaaa4", description: "Active dust and sand storm advisories" },
  { id: "weather_radar",       label: "Weather Radar",              group: "environment",  sourceIds: ["noaa_weather_alerts"],  defaultVisible: false, color: "#80cbc4", description: "RainViewer global precipitation radar" },
  { id: "heat_extremes",       label: "Heat Index Extremes",        group: "environment",  sourceIds: ["noaa_weather_alerts"],  defaultVisible: false, color: "#ff7043", description: "Extreme heat advisories and warnings" },
  ...
  { id: "coral_bleaching",     label: "Coral Reef Bleaching",       group: "environment",  sourceIds: ["noaa_weather_alerts"],  defaultVisible: false, color: "#f48fb1", description: "NOAA coral bleaching watch/alert status" },
  ...
  { id: "armed_conflicts",     label: "Armed Conflicts",            group: "security",     sourceIds: ["acled_conflicts"],                defaultVisible: true,  color: "#ff5252", description: "ACLED conflict events — last 30/90/180 days" },
  { id: "airstrikes",          label: "Airstrikes & Kinetic",       group: "security",     sourceIds: ["acled_conflicts", "gdelt"],       defaultVisible: false, color: "#f50057", description: "Filtered airstrike and kinetic events" },
  { id: "civil_unrest",        label: "Protests & Civil Unrest",    group: "security",     sourceIds: ["acled_conflicts", "gdelt"],       defaultVisible: false, color: "#ff6d00", description: "Active protests and unrest events" },
  { id: "terrorism",           label: "Terrorism Incidents",        group: "security",     sourceIds: ["acled_conflicts"],                defaultVisible: false, color: "#d50000", description: "GTD-sourced terrorism incidents" },
  ...
  // ── MILITARY & DEFENSE (8) ───────────────────────────────────────────────
  { id: "military_bases",      label: "Military Bases",             group: "military",     sourceIds: ["acled_conflicts"],      defaultVisible: false, color: "#546e7a", description: "OSM military tag + curated global bases" },
  ...
  { id: "military_hq",         label: "Military HQ Locations",      group: "military",     sourceIds: ["acled_conflicts"],      defaultVisible: false, color: "#607d8b", description: "Curated command & control locations" },
